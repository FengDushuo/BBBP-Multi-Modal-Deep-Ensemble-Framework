...
output_path = 'D:/a_work/1-phD/project/5-VirtualScreening/processed_data_morgan_opt.pkl'
...
invalid_smiles = data[data['Morgan'].apply(lambda x: x == [0] * 2048)]
log_message(f"Invalid SMILES count: {len(invalid_smiles)}")
data = data[data['Morgan'].apply(lambda x: x != [0] * 2048)]
