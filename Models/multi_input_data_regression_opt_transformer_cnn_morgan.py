...
fingerprint_pca = PCA(n_components=128)
...
for train_idx, test_idx in kf.split(fingerprints):
    ...
    # XGBoost
    xgb_model = XGBRegressor(n_estimators=300, max_depth=15, learning_rate=0.1, random_state=42)
...
with open("stacked_model_morgan.pkl", "wb") as f:
...
with open("stacked_model_morgan.pkl", "rb") as f:
...
plt.savefig("stacked_model_morgan_predictions.png")
plt.show()
